...
CONTAINER_NAME="khunquant-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.khunquant/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run khunquant:"
echo "  cd packages/khunquant && go run ./cmd/khunquant gateway"
echo ""
