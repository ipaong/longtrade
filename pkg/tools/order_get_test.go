...
func TestGetOrder_MissingProvider(t *testing.T) {
	cfg := config.DefaultConfig()
	tool := NewGetOrderTool(cfg)
...
func TestGetOrder_EmptyProvider(t *testing.T) {
	cfg := config.DefaultConfig()
	tool := NewGetOrderTool(cfg)
...
func TestGetOrder_NonexistentProvider(t *testing.T) {
	cfg := config.DefaultConfig()
	tool := NewGetOrderTool(cfg)
...
func TestGetOrder_WithAccount(t *testing.T) {
	cfg := config.DefaultConfig()
	tool := NewGetOrderTool(cfg)
...
func TestGetOrder_ParametersSchema(t *testing.T) {
	tool := NewGetOrderTool(config.DefaultConfig())
...
func TestGetOrder_Name(t *testing.T) {
	tool := NewGetOrderTool(config.DefaultConfig())
	name := tool.Name()
	if name != NameGetOrder {
		t.Errorf("Name() = %q, want %q", name, NameGetOrder)
	}
}

func TestGetOrder_Description(t *testing.T) {
	tool := NewGetOrderTool(config.DefaultConfig())
...
func TestGetOrder_NumericOrderID(t *testing.T) {
	cfg := config.DefaultConfig()
	tool := NewGetOrderTool(cfg)
...
func TestGetOrder_AlphanumericOrderID(t *testing.T) {
	cfg := config.DefaultConfig()
	tool := NewGetOrderTool(cfg)
