...
// Client credentials must be supplied explicitly through environment variables.
func GoogleAntigravityOAuthConfig() OAuthProviderConfig {
	clientID := strings.TrimSpace(os.Getenv("KHUNQUANT_GOOGLE_ANTIGRAVITY_CLIENT_ID"))
	clientSecret := strings.TrimSpace(os.Getenv("KHUNQUANT_GOOGLE_ANTIGRAVITY_CLIENT_SECRET"))
...
func GoogleGeminiOAuthConfig() OAuthProviderConfig {
	clientID := strings.TrimSpace(os.Getenv("KHUNQUANT_GOOGLE_GEMINI_CLIENT_ID"))
	clientSecret := strings.TrimSpace(os.Getenv("KHUNQUANT_GOOGLE_GEMINI_CLIENT_SECRET"))
