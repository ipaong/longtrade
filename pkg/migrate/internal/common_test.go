...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.khunquant")
	assert.Equal(t, "/home/user/.khunquant/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.khunquant/workspace/file.txt", "/home/user/.khunquant")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".khunquant"), result)
}
